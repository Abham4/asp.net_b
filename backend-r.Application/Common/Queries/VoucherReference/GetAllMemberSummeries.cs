...
{
    public class GetAllMemberSummeries : IRequest<IEnumerable<AllVoucherReference>> {}

    public class GetAllMemberSummeriesHandler : IRequestHandler<GetAllMemberSummeries,
        IEnumerable<AllVoucherReference>>
    {
        ...
        public GetAllMemberSummeriesHandler(IVoucherReferenceRepository voucherReferenceRepository,
        ...
        public async Task<IEnumerable<AllVoucherReference>> Handle(GetAllMemberSummeries request, CancellationToken cancellationToken)
        {
            var voucherReferences = await _voucherReferenceRepo.GetAllAsync();

            _logger.LogInformation("--------Listing All Member Summary------------");
            ...
            {
                var summaryVoucher = await _voucherRepo.GetVoucherSummaryByIdForMember(summaryVoucherId);
