...
{
    public class GetAllOrganizationSummeries : IRequest<IEnumerable<AllVoucherReference>> {}

    public class GetAllOrganizationSummeriesHandler : IRequestHandler<GetAllOrganizationSummeries,
        IEnumerable<AllVoucherReference>>
    {
        ...
        public GetAllOrganizationSummeriesHandler(IVoucherReferenceRepository voucherReferenceRepository,
        ...
        public async Task<IEnumerable<AllVoucherReference>> Handle(GetAllOrganizationSummeries request, CancellationToken cancellationToken)
        {
            var voucherReferences = await _voucherReferenceRepo.GetAllAsync();

            _logger.LogInformation("---------Listing All Organization Summary------------");
            ...
            {
                var summaryVoucher = await _voucherRepo.GetVoucherSummaryByIdForOrganization(summaryVoucherId);
                ...
                if(summaryVoucher != null)
                    allVoucherReference.Add(new AllVoucherReference{
                        ...
                        DetailVouchers = detailVouchers != null ? detailVouchers.Select(c => new PurchasedProduct
                        .Vms.Voucher{
                            Id = c.Id,
                            Code = c.Code,
